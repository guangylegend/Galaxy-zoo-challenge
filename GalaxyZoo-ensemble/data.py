...
data_transforms = transforms.Compose([
    ...
    transforms.Scale((45, 45)),
    transforms.RandomHorizontalFlip(),
    transforms.RandomVerticalFlip(),
    transforms.FiveCrop(32),
    transforms.Lambda(lambda crops: torch.cat([transforms.ToTensor()(crop) for crop in crops], 0)),
    transforms.Normalize(
        (0.0930514,0.08065233,0.06301059,
         0.0930514,0.08065233,0.06301059,
         0.0930514,0.08065233,0.06301059,
         0.0930514,0.08065233,0.06301059,
         0.0930514,0.08065233,0.06301059), 
        (0.13712655,0.11481636,0.09914573,
         0.13712655,0.11481636,0.09914573,
         0.13712655,0.11481636,0.09914573,
         0.13712655,0.11481636,0.09914573,
         0.13712655,0.11481636,0.09914573)),
